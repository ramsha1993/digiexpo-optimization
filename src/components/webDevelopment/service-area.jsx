...
<div
      className={`${styles["tp-service-area"]} purple-bg p-relative pt-115 pb-105 pb-sm-0 pt-sm-0`}
    >
      ...
      <div className="container">
        <div className="row align-items-end mb-60">
          ...
          >
            <div
              className={`${styles["tp-service-sction-content"]} pb-15 d-flex justify-content-end`}
            >
        ...
        >
          <div className="row">
            {/* STEP ONE */}
            <div
              className={`col-xl-3 col-lg-4 col-md-6 mb-50 tp-service-4-border-right tp-service-4-right service-border-trang-1`}
            >
              <div className={`${styles["tp-service-4-item"]}  tp-service-four-item z-index`}>
                ...
                <div className={styles["tp-service-4-content"]}>
                  ...
                  <h4 className={styles["tp-service-4-title"]}>
                    <Link href="/service-details">Discovery and Planning</Link>
                  </h4>
                  <span >
            ...
            >
              <div className={`${styles["tp-service-4-item"]} tp-service-four-item z-index`}>
                ...
                <div className={styles["tp-service-4-content"]}>
                  <span className={styles["tp-service-step"]}>STEP TWO</span>
                  <h4 className={styles["tp-service-4-title"]}>
                    <Link href="/service-details">Development and Coding</Link>
                  </h4>
                  <span className={styles["tp-service-desc"]}>
            ...
            >
              <div className={`${styles["tp-service-4-item"]}  tp-service-four-item z-index`}>
                ...
                <div className={styles["tp-service-4-content"]}>
                  <span className={styles["tp-service-step"]}>STEP THREE</span>
                  <h4 className={styles["tp-service-4-title"]}>
                    <Link href="/service-details">Testing and Quality Assurance</Link>
                  </h4>
                  <span className={styles["tp-service-desc"]}>
                    Punctilious testing is conducted to recognize and resolve
                    bugs, ensure cross-browser compatibility, and optimize load
                    times. User experience and functionality are thoroughly
            ...
            >
              <div className={`${styles["tp-service-4-item"]} z-index`}>
                ...
                <div className={styles["tp-service-4-content"]}>
                  <span className={styles["tp-service-step"]}>STEP FOUR</span>
                  <h4 className={styles["tp-service-4-title"]}>
                    <Link href="/service-details">Deployment and Maintenance</Link>
                  </h4>
                  <span className={styles["tp-service-desc"]}>
                    ...
                    date. The ongoing updates, backups, and support are provided
