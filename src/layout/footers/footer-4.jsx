...
const footer_content = {
   ...
   footer_links1: [
      { name: "SMM", link: "/digital-marketing-agency-dubai" },
      { name: "SEO", link: "/digital-marketing-agency-dubai" },
      { name: "PPM", link: "/digital-marketing-agency-dubai" },
      { name: "Email Marketing", link: "/digital-marketing-agency-dubai" },
      { name: "Influencer Marketing", link: "/digital-marketing-agency-dubai" },
      { name: "Public Relation (PR)", link: "/digital-marketing-agency-dubai" },
      { name: "PPC", link: "/digital-marketing-agency-dubai" },

   ],
   footer_links2: [
      { name: "Web Design", link: "/website-development-company-in-dubai" },
      { name: "Wordpress Development", link: "/website-development-company-in-dubai" },
      { name: "Web Application", link: "/website-development-company-in-dubai" },
      { name: "CMS Development", link: "/website-development-company-in-dubai" },
      { name: "Laravel Development", link: "/website-development-company-in-dubai"},
      { name: "Webflow Development", link:"/website-development-company-in-dubai" },
      { name: "Website Maintanance", link:"/website-development-company-in-dubai" },
   ],
   footer_links3: [
      { name: "Hybrid Apps", link: "/mobile-app-development-company-dubai" },
      { name: "Android App Development", link: "/mobile-app-development-company-dubai" },
      { name: "IOS App Development", link: "/mobile-app-development-company-dubai" },
      { name: "React Native Apps", link: "/mobile-app-development-company-dubai" },
      { name: "Flutter Apps", link: "/mobile-app-development-company-dubai" },
      { name: "Progressive Web Apps (PWAs)", link: "/mobile-app-development-company-dubai" },
   ],
}
